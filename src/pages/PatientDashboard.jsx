...
const PatientDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [apptRes, docRes, hospRes, pharmRes, patRes] = await Promise.all([
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="flex-1 p-5 overflow-y-auto">
            ...
            <div className="mb-5">
              <div className="flex items-center justify-between mb-3">
                ...
                <button onClick={() => navigate('/patient/appointments')} className="text-xs text-green-600 hover:underline">View all →</button>
              </div>
          ...
          <div className="w-56 border-l bg-white flex flex-col">
            ...
            <div className="p-4 border-b">
              <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center text-green-700 font-medium mb-3">
                {user?.fullName?.charAt(0)}
              </div>
              ...
              {patientData && (
                <>
                  <div className="flex justify-between text-xs mb-1">
                    ...
                    <span className="font-medium text-green-600">{patientData.BloodType || '—'}</span>
                  </div>
                  <div className="flex justify-between text-xs mb-1">
              ...
              <button
                ...
                className="w-full mt-3 bg-green-50 text-green-700 text-xs py-2 rounded-lg hover:bg-green-100 transition-colors"
              >
                📋 View medical file
              </button>
            </div>
